    ...
    class FeedAdapter(data: MutableList<FeedModel>?) : BaseQuickAdapter<FeedModel, BaseViewHolder>(data) {
        init {
            ...
            multiTypeDelegate.registerItemType(type_unknow.ordinal, R.layout.item_test)
                    .registerItemType(tag_question.ordinal, R.layout.item_test)
                    .registerItemType(tag_article.ordinal, R.layout.item_test)
                    ...
                    .registerItemType(editor_elite_answer.ordinal, R.layout.item_test)
                    ...
                    .registerItemType(vote_answer.ordinal, R.layout.item_feed_tag_answer)
        }
